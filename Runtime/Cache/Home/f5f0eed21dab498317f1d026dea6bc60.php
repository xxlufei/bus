...
<html>
	<head>
		...
		<script src="/Public/Home/js/angular.js"></script>
		<script src="/Public/Home/js/jquery.form.js"></script>
		<style type="text/css">
			body{background: url(/Public/Home/images/login.jpg) no-repeat;background-size: cover;font-size: 16px;}
			...
			<form role="form" ng-app="myApp" ng-controller="validateCtrl"
				...
				<div class="col-sm-9 col-md-9">
					...
					<div class="form-group">
						...
						<hr />
						<a href="<?php echo U('register');?>" id="register_btn" class="">没有账号?点击注册</a>
					</div>
					<div class="form-group">
