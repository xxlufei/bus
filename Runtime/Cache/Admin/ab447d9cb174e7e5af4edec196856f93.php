	    ...
	    <div class="short-input select ue-clear">
	        ...
	        <div class="select-wrap">
	        	<select name="pid">
					...
					<?php if(is_array($rst)): $i = 0; $__LIST__ = $rst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>"><?php echo ($vol["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
